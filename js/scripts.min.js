...
*/
!function(a){a.fn.chart=function(b,c){function d(a){var b=1,c=m,d=n;a.strokeStyle="#000",a.lineWidth=b,// y axis
...
s=a.pageX-n+$(window).scrollLeft(),t=a.pageY-m+$(window).scrollTop(),s/=A,t/=A}function d(){u=s-q,v=t-r}function e(a){if(p===!1)return!1;c(a),d(),k.calculateCorners(u,v),o.clearRect(0,0,z,B);/*objects.forEach(function(obA, i) {
...
var b=a.dataTransfer.files;if(b)for(var d=0,e=b.length;e>d;d++){var f=b[d];!function(a){var b=new FileReader;-1!==a.type.search("image")?a.size<3145728?(b.onload=function(){var b=this.result,d=a.name;console.log(d),c.innerHTML+="<p>File name: "+a.name+" <br/>File size: "+a.size+" bytes  </p>",document.getElementById("drop").innerHTML+='<img src="'+b+'" />'},b.readAsDataURL(a)):document.getElementById("drop").innerHTML+="File is too big. Try to upload smaller image.<br/>":-1!==a.type.search("text")&&(b.onload=function(){result=this.result,c.innerHTML+="<p>File name: "+a.name+" <br/>File size: "+a.size+" bytes  </p>",document.getElementById("drop").innerHTML+=result+"<br/>"},b.readAsText(a))}(f)}return c.innerHTML+=a.dataTransfer.getData("text"),!1}}();/**
 * @author Bartek Fryzowicz
 * TODO: make rotator responsive
 */
var paginator;!function(a){var b={arrows:!0,numeric:!0,navClass:"menu",itemClass:"nav-item",prevText:"&laquo;",nextText:"&raquo;",icons:!1,numericClass:"item-number"};paginator=function(c){function d(){l.icons&&e();for(var b=0,c=o;c>b;b++){var d=b+1;l.icons&&(d='<img src="'+k[b]+'" />');var f=a("<li/>",{"class":l.numericClass+" "+l.itemClass}).append('<a href="#">'+d+"</a>");u.append(f)}t=a(s,u)}function e(){k=[],p.find(l.itemSelector).each(function(){var b=a(this).data("thumb");k.push(b)})}function f(){i=a('<a href="#" />').html(r),g=a("<li/>",{"class":l.itemClass+" prev"}).append(i),j=a('<a href="#" />').html(q),h=a("<li/>",{"class":l.itemClass+" next"}).append(j),u.prepend(g),u.append(h)}var g,h,i,j,k,l=a.extend({},b,c),m=l.arrows,n=l.numeric,o=l.itemsNumber,p=l.parent,q=l.nextText,r=l.prevText,s="."+l.numericClass,t=[],u=a("<ul>",{"class":l.navClass+" js-generated"});return n&&d(),m&&f(),p.append(u),{container:u,prevButton:i,nextButton:j,items:t}}}(jQuery);var galleryRotator;!function(a){galleryRotator=function(b,c,d){function e(a){"function"==typeof a&&a()}function f(){x=C.find(".originalImage"),A=x.height(),G=x.width(),z=15,C.height(A),B=Math.floor(G/z),S=!1,("fade"===t.effect||"sharp"===t.effect)&&(z=1,B=G)}function g(){function b(){f(),F.each(function(){var b=a(".rotator-slice",this),c=0;b.css("background-size",G).each(function(b){var d=B,e=G-(b+1)*d;b===z-1&&1!==z&&(e=0,d=c),c=e,a(this).css({backgroundPosition:-e+"px 0",backgroundSize:G,height:A,width:d,left:e})}).finish()})}C.find("img").addClass("originalImage").css("visibility","hidden"),f(),h(),x.each(function(b){Q[b]=a(this).attr("src")}),F.each(function(b){for(var c=0;z>c;c++)a("<div >",{"class":t.effect+" rotator-slice o-"+(c+1),css:{backgroundImage:"url("+Q[b]+")"}}).appendTo(a(this))}),F.each(function(b){R[b]=a(this).find(".rotator-slice")}),y=F.eq(L),b(),a(window).on("resize",function(){b()})}function h(){F.each(function(b){a(this).css({zIndex:H-b})})}function i(b){if(S)return!1;var f=L,g=I/z;e(c),"next"===b?(L++,L===H&&(L=0),S=!0,T=R[f],"dissolve"===t.effect||"fade"===t.effect?T.each(function(b){a(this).animate({opacity:0},g*(b+1),function(){b===z-1&&(S=!1,k(),j(f),e(d))})}):"sharp"===t.effect&&T.each(function(b){a(this).animate({width:0},g*(b+1),function(){b===z-1&&(S=!1,k(),j(f),e(d))})})):"prev"===b?(L--,0>L&&(L=H-1),k(L),j(f)):(k(L),j(f)),r()}function j(a){R[a].css("opacity",1),1===z&&R[a].css("width",B),y=F.eq(L)}function k(){var b=L;F.each(function(c){b>c?a(this).css("z-index",b-c-1):c>b?a(this).css("z-index",H-(c-b)):c===b&&a(this).css("z-index",H)})}function l(){v=setInterval(function(){V[D]()},J)}/* core functions */
function m(){C.wrap('<div class="gallery-wrapper">')}function n(){"undefined"!=typeof O?(M.container=a(O,u),M.prevButton=a(".prev a",M.container),M.nextButton=a(".next a",M.container),M.items=a("."+K.numericClass,M.container)):(K.arrows||K.numeric)&&(M=o())}function o(){var a=K;return a.parent=u,a.itemsNumber=H,a.itemSelector=E,paginator(K)}function p(){K.arrows&&(M.nextButton.on("click",function(){return q(),U[D]("next"),!1}),M.prevButton.on("click",function(){return q(),U[D]("prev"),!1})),K.numeric&&M.items.on("click",function(){return q(),w=L,L=a(M.items,M.container).index(this),U[D](),!1})}function q(){clearInterval(v),N&&l()}function r(){if(K.numeric){var a=L%H;0>a&&(a=H+a),M.container.find(M.items).removeClass("active").eq(a).addClass("active")}}var s={panelSelector:".panel.carousel",gallerySelector:"ul",type:"carousel",speed:600,duration:4e3,visibleItems:1,effect:"fade",autostart:!0,navigation:{arrows:!0,numeric:!0,numericClass:"item-number"},itemSelector:"li"},t=a.extend(!0,{},s,b),u=a(t.panelSelector);if(!u.length)return!1;var v,w,x,y,z,A,B,C=a(t.gallerySelector,u),D=t.type,E=t.itemSelector,F=a(E,C).addClass("item"),G=F.width(),H=F.length,I=t.speed,J=t.duration,K=t.navigation,L=0,M={},N=t.autostart,O=t.navigationSelector,P={stack:g},Q=[],R=[],S=!1,T=[],U={stack:i},V={stack:function(){U[D]("next")}};P[D](),m(),n(),r(),p(),N&&l()}}(jQuery),$(window).on("load",function(){galleryRotator({panelSelector:".gallery-section-rotator",type:"stack",effect:"dissolve",speed:1e3}),galleryRotator({panelSelector:".gallery-section-fade",type:"stack",effect:"sharp",speed:1700,autostart:!1})}),/*
* author: Bartlomiej Fryzowicz
*/
