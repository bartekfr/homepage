...
function getRangeOfText(a,b,c){"use strict";/**
	 ...
	 * @returns {Range}
	*/
function d(a,b,c){var d=document.createRange(),e=document.createTreeWalker(a,NodeFilter.SHOW_TEXT,null,!1),f=0,g=null,h=0,i=!1,j=!1,k=b.length,l=a.textContent.indexOf(b,c),m=l+k;if(0>l)return null;for(;e.nextNode();){//set start position of a range
if(g=e.currentNode,h=g.textContent.length,f+=h,f>=l&&!i){var n=h-(f-l);d.setStart(g,n),i=!0}//if range start position has been already set, try to set end position
if(i&&f>=m){var o=h-(f-m);d.setEnd(g,o),j=!0;break}}return d.endIndex=m,i&&j?d:null}var e=a instanceof Element,f="string"==typeof b;if(!e||!f)throw"Invalid arguments";return"undefined"==typeof c&&(c=0),d(a,b,c)}!function(a){a.fn.chart=function(b,c){function d(a){var b=1,c=m+.5,d=n+.5;a.strokeStyle="#000",a.lineWidth=b,// y axis
...
N[A](),n(),r(),p(),K&&m()}}(jQuery),$(window).on("load",function(){galleryRotator({panelSelector:".gallery-section-rotator",type:"stack",effect:"dissolve",speed:1e3,autostart:!1}),galleryRotator({panelSelector:".gallery-section-blind",type:"stack",effect:"blind",speed:1700,autostart:!0})});var Select=function(a){"use stric";/**
	 ...
	 * @returns {object}
	 */
return function(b,c){function d(){l=getRangeOfText(i,c,k),g()}function e(){return l?(k=l.endIndex,d(),l||(k=0,d()),void 0):!1}function f(){j.empty?// Chrome
j.empty():j.removeAllRanges&&// Firefox
j.removeAllRanges()}function g(){return l?(f(j),j.addRange(l),console.log(l),void 0):!1}function h(a){k=0,c=a,d()}var i=b,j=a.getSelection(),k=0,l=null;return"undefined"!=typeof c&&d(),{setText:h,selectNext:e}}}(window);//initialization TOTO: move to separate file
!function(a,b){"use stric";//init
var c=b.getElementById("root");if(!c)return!1;var d,e=b.getElementById("next"),f=b.getElementById("textToFind"),g=b.getElementById("find"),h=Select(c);g.addEventListener("click",function(){d=f.value,h.setText(d)},!1),e.addEventListener("click",function(a){a.preventDefault(),h.selectNext()},!1)}(window,document),/*
* author: Bartlomiej Fryzowicz
*/
