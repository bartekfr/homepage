...
var ab,bb={pendulum:i,carousel:j,stack:m},cb={carousel:function(){bb[D]("next")},pendulum:function(){Q>=J-K?ab="prev":0===Q&&(ab="next"),bb[D](ab)},stack:function(){bb[D]("next")}};U[D](),q(),r(),v(),t(),S&&p()}}(jQuery),$(function(){galleryRotator({panelSelector:".gallery-section-rotator",type:"stack",effect:"dissolve",speed:1700})}),/*
* author: Bartlomiej Fryzowicz
*/
