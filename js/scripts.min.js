 ...
 * @returns {Range}
*/
function getRangeOfText(a,b,c){"use strict";/**
	 ...
	 * @returns {Range}
	*/
function d(a,b,c){var d=document.createRange(),e=document.createTreeWalker(a,NodeFilter.SHOW_TEXT,null,!1),f=0,g=null,h=0,i=!1,j=!1,k=b.length,l=a.textContent.indexOf(b,c),m=l+k;if(0>l)return null;for(;e.nextNode();){
//set start position of a range
if(g=e.currentNode,h=g.textContent.length,f+=h,f>=l&&!i){var n=h-(f-l);d.setStart(g,n),i=!0}
//if range start position has been already set, try to set end position
if(i&&f>=m){var o=h-(f-m);d.setEnd(g,o),j=!0;break}}return d.endIndex=m,i&&j?d:null}var e=a instanceof Element,f="string"==typeof b;if(!e||!f)throw"Invalid arguments";return"undefined"==typeof c&&(c=0),d(a,b,c)}!function(a){a.fn.chart=function(b,c){function d(a){var b=1,c=m+.5,d=n+.5;a.strokeStyle="#000",a.lineWidth=b,
// y axis
a.beginPath(),a.moveTo(c,5+j),a.lineTo(c,d+1),//add 2
a.stroke(),a.closePath(),
//x axis
a.beginPath(),a.moveTo(c-5,d),a.lineTo(k-5,d),a.stroke(),
//arrows
// y arrow
a.lineWidth=1,a.beginPath(),a.moveTo(c,0+j),a.lineTo(c+4,15+j),a.lineTo(c-4,15+j),a.closePath(),a.fill(),a.closePath(),
//x arrow
a.beginPath(),a.moveTo(k,d),a.lineTo(k-15,d-4),a.lineTo(k-15,d+4),a.closePath(),a.fill(),a.closePath();
//y values
...
s=a.pageX-n+$(window).scrollLeft(),t=a.pageY-m+$(window).scrollTop(),s/=A,t/=A}function d(){u=s-q,v=t-r}function e(a){if(p===!1)return!1;c(a),d(),k.calculateCorners(u,v),o.save(),
